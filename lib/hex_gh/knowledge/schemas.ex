defmodule HexGh.Knowledge.Schemas do
  @moduledoc """
  ...
  defp entry_fields do
    [
      ...
      {"resolved_in",
       %{
         type: ["string", "null"],
         description: ~s|Version the issue was fixed in, e.g. "1.8.0", or null.|
       }},
      {"repo",
  ...
  defp stack_description do
    ~s|Technologies involved, lowercase with underscores (e.g. ["elixir", "postgres", "anubis_mcp"]). | <>
      "Infer implicit layers even when not named: Caddyfile/reverse_proxy/502/504 implies caddy; " <>
      "mix.exs/Plug/GenServer/LiveView/Ecto implies elixir and phoenix; " <>
      "docker-compose/container implies docker; pgvector/postgrex/psql implies postgres."
  end
end
